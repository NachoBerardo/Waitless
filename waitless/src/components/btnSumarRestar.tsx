...
const btnSumarRestar: React.FC=()=>{
  ...
  return  <div className="border-solid border-2 border-[#252525] absolute rounded-2xl right-0 flex items-center justify-between mr-[126px] h-[38px] w-[89px]">
